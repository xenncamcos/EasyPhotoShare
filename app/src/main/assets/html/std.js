...
$(function() {
	...
	$('.simg').on('click', function() {
		...
		now = imgs.indexOf($(this).attr('title'));
		$('.sbox:nth-of-type(' + (now + 1) + ')').css('border', 'solid 2px #8af');
		$('.sbox:nth-of-type(' + (imgp + 1) + ')').css('border', 'solid 2px #666');
		imgp = now;
